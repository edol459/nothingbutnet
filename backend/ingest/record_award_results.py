...
NBA_AWARDS  = ["MVP", "ROTY", "DPOY", "6MOY", "MIP"]
WNBA_AWARDS = ["MVP", "ROTY", "DPOY", "6WOY", "MIP"]
...
def main():
    ...
    if args.set:
        ...
        print("WNBA winners have no upstream feed — pass them with --set, e.g.\n"
